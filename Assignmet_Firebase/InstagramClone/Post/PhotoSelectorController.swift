...
class PhotoSelectorController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if !self.selectedImage.contains(selectedImage) {
            self.selectedImage.append(selectedImage)
        } else {
            if let index = self.selectedImage.firstIndex(of: selectedImage), self.selectedImage.count > 1 {
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        header.photoImageView.image = selectedImage.last
        
        self.header = header
        
        if let selectedImage = selectedImage.last {
